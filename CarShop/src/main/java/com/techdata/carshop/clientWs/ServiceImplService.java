 ...
 * 
 */
@WebServiceClient(name = "ServiceImplService", targetNamespace = "http://impl.service.carshop.mycompany.com/", wsdlLocation = "http://localhost:8088/carshopservice?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SERVICEIMPLSERVICE_QNAME = new QName("http://impl.service.carshop.mycompany.com/", "ServiceImplService");
    ...
    public ServiceImpl getServiceImplPort() {
        return super.getPort(new QName("http://impl.service.carshop.mycompany.com/", "ServiceImplPort"), ServiceImpl.class);
    }
    ...
    public ServiceImpl getServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://impl.service.carshop.mycompany.com/", "ServiceImplPort"), ServiceImpl.class, features);
    }
